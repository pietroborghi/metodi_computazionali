...
int main (int argc, const char * argv[]) {
  ...
  // PARAMETRI ATOMO ARGON

  double rho, r_co, T;  // densità, raggio di cut-off (per potenziale LJ) e temperatura
  double eps = 120; // dispersion energy (in units of kB)
  double sigma = 3.4; // size of the particle (in Angrstrom)
  double m = 39.95*1.6747e-27; //massa atomo Argon
